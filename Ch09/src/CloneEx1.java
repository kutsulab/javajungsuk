...
public class CloneEx1 {
	...
	public static void main(String[] args) {
		...
		Point copy = (Point) original.clone(); // Object 클래스로 형변환 되어서 반환되었으므로 다시 원래 클래스로 형변환해야한다.
...
class Point  implements Cloneable {
	...
	@Override
	public Object clone() { // 다른 클래스에서 clone()을 호출하려면 public으로 접근제어자를 오버라이드 해야한다.
		...
		return obj; // Object 클래스의 참조변수로 반환되므로 호출한 쪽에서 원래 클래스로 형변환해야한다.
	}
