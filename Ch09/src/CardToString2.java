...
public class CardToString2 {
	/* 자바의 정석 3판 p.455 예제 9-6
	 * 
	 * toString() 메서드는 인스턴스의 클래스명, 16진수화 된 해시코드를 반환한다.
	 * toString() 호출 시 다른 내용을 표시시키도록 오버라이드할 수 있다.
	 */
	
	public static void main(String[] args) {
		
		System.out.println("c1을 뽑습니다.");
		Card2 c1 = new Card2(); // Card 인스턴스 생성
		System.out.println(c1+"\n");
		System.out.println("c2를 뽑습니다.");
		Card2 c2 = new Card2(); // Card 인스턴스 생성
		System.out.println(c2+"\n");

		System.out.println("c3를 뽑습니다.");
		Card2 c3 = new Card2("CLOVER", 7); // 매개변수 생성자를 통하여 Card 인스턴스 생성
		System.out.println(c3+"\n");
		
		System.out.println("c4를 뽑습니다.");
		Card2 c4 = new Card2("FLOWER", 200); // 범위에서 벗어난 값을 생성자의 매개변수로 입력
